...
public class PostJobController {
    ...
    public void execute(String jobTitle, String jobDescription, String jobLocation) {
        //creates an input data that can be used by the use case interactor(postjobinteractor)
        final PostJobInputData postJobInputData = new PostJobInputData(jobTitle, jobDescription, jobLocation);
